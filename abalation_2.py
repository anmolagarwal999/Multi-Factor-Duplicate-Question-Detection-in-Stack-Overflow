...
class Ablation:
    def __init__(self, score_path="", param_ablate=""):
    ...
    def duplicate_similarity(self):
        ...
        self.dup_score_details={'4952':self.dup_score_details['4952']}
...
if __name__ == "__main__":
    ...
    abalate_idx=-1
    ablation = Ablation(score_path=sys.argv[1])
    ...
    with open(f"best_score_abalating_{abalate_idx}.json",'w') as fd:
        json.dump({"best_score":best_score,"best_params":best_params}, fd, indent=3)
